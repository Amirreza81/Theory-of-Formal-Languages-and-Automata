...
\settextfont[Path="./template/fonts/",Scale=0.99 , BoldFont = XB Zar bold.ttf]{XB Zar.ttf}
\setlatintextfont[Path="./template/fonts/"]{Times New Roman.ttf}
...
\makeatother	
\setdigitfont[Path="./template/fonts/",Scale=1]{XB Zar.ttf} 
\setmathdigitfont[Path="./template/fonts/",Scale=1]{XB Zar.ttf} 